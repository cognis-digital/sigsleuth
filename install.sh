#!/usr/bin/env sh
# Universal installer for sigsleuth. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/sigsleuth.git"
echo "Installing sigsleuth ..."
