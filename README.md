...
[![PyPI](https://img.shields.io/pypi/v/cognis-sigsleuth.svg)](https://pypi.org/project/cognis-sigsleuth/)
[![CI](https://github.com/cognis-digital/sigsleuth/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/sigsleuth/actions)
...
SIGSLEUTH exists for one job — decodes raw calldata and eip-712 typed-data into human-readable intent, flagging blind-signing and malicious permit/permit2 payloads. — and does it without a SaaS bill or heavyweight setup.
...
```bash
sigsleuth --version
sigsleuth scan .                      # scan the current project
sigsleuth scan . --format json
sigsleuth scan . --fail-on high       # non-zero exit for CI gates
sigsleuth mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **ScopeLift's 'what does this transaction do' / Etherscan calldata decoder**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`sigsleuth` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
